...
puts "But if we want to convert his weight to Kilograms #{name} would
weigh #{weight * lb_to_kg_conversion} Kg"
puts "Also, he would be #{height * inch_to_cent_conversion} centimeters tall "
